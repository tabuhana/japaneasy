      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="max-w-lg space-y-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} value={field.value ?? ''} placeholder="e.g. #FF6B35" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <div className="flex gap-2 pt-4">
          <Button type="submit" disabled={form.formState.isSubmitting}>
            {form.formState.isSubmitting ? 'Saving...' : initialData ? 'Update Unit' : 'Create Unit'}
          </Button>
          <Button type="button" variant="default" onClick={() => router.push('/admin/units')}>
            Cancel
          </Button>
        </div>
      </form>
