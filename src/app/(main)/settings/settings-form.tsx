        ...
        <div className="flex max-w-2xl flex-col gap-8">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-baloo text-xl font-bold text-[#5C3D2E]">
                Account Information
              </h2>
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="rounded-xl border border-[#E8CDB5] bg-white p-6">
              ...
              <div className="mt-4 rounded-lg border border-dashed border-[#E8CDB5] bg-[#FFF8F3] p-4">
                ...
                <Button variant="primary" className="cursor-pointer" disabled>
                  Coming Soon
                </Button>
              </div>
            </div>
          ...
          <section className="space-y-4 pb-12">
            ...
            <div className="rounded-xl border border-rose-200 bg-rose-50/50 p-6">
              ...
              <Button variant="danger" className="cursor-pointer" disabled>
                Delete Account
              </Button>
            </div>
          </section>
