        ...
        >
          <div className='mb-8'>
            ...
            <div className='border-primary/30 inline-block rounded-2xl border-2 border-dashed p-6'>
              <span className='text-foreground text-8xl'>{card.word.kanji ?? card.word.kana}</span>
            </div>
          </div>

          {card.word.kanji && <p className='text-primary mb-8 text-2xl'>{card.word.kana}</p>}
            ...
            {options.map(option => {
              ...
              if (showResult) {
                if (option === correctAnswer) {
                  ...
                  buttonClass = 'bg-card border-2 border-muted text-muted-foreground opacity-50';
                }
              }
          ...
          {showResult && (
            <div className='animate-in fade-in slide-in-from-bottom-4 mt-8 flex flex-col items-center duration-300'>
              <p className={cn('mb-4 text-2xl', isCorrect ? 'text-green-600' : 'text-red-500')}>
