# Notes
These are just notes and design decisions I've made for the app. Writing it here to just remind myself. 

## App subdomains

The app has no marketing because the marketing page will be handled for a separate app. Going to use a subdomain app.japaneasy.com 
instead of having a dashboard
I find the dashboard design to be very ugly to me personally, even though it doesn't effect the user.

## The importance of data

Apps are just data. What data do you want to store. What data do you want to share. What data do you want to transfer. Etc. A key concept is focusing on how youre going to be handling your data in your app. Not just about databases but how youre organizing the data, composing the data, presenting the data. Its the CORE of appplications. Because of this I'm splitting the word content in the app into sections separting each level. The words are the back bone of the app. Handling how we deal with each word should be very sepecific and not just filtered through and pushed to a db. We need more concrete use of the data and more documentation for implementing the words with the coures (in the future) and ways users can more easily interact with our data both paid and free.
